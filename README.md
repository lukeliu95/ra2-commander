...
这些经验已经作为初始知识写进 `assets/seed/`：方案 v000→v003、对手档案 `ai-easy`（盟军、苏军两个小节）、战术库 T-001～T-015、三局的完整记录。下一局默认使用 v003。
...
- 已测试环境：gonghui.k0s.cn 客户端 v0.87.0，单机模式 → 遭遇战，AI-简单，地图"岛屿之战 (2)"。我方打过盟军，也在冒烟测试中打过苏军；对手遇到过盟军和苏军，两种出生点都出现过。
...
assets/seed/                初始经验：方案 v000–v003、对手档案、战术库、三局记录（含 match-003 全部复盘产物）
```
